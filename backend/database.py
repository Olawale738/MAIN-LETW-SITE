    ...
    try:
        async with engine.connect() as conn:
            ...
            missing_columns: list[tuple[str, str, str]] = [
                ...
                ("integration_settings", "registrar_title",                "VARCHAR(120)"),
                ("integration_settings", "registrar_signature_url",        "TEXT"),
                ("integration_settings", "deputy_registrar_name",          "VARCHAR(160)"),
                ("integration_settings", "deputy_registrar_title",         "VARCHAR(120)"),
                ...
                ("custom_ministries", "description",                "TEXT"),
                ("custom_ministries", "hero_image_url",             "VARCHAR(500)"),
                ("custom_ministries", "icon_url",                   "VARCHAR(500)"),
                ("custom_ministries", "color",                      "VARCHAR(20) DEFAULT '#140152'"),
                ("custom_ministries", "secondary_color",            "VARCHAR(20) DEFAULT '#7c3aed'"),
                ("custom_ministries", "icon_name",                  "VARCHAR(50) DEFAULT 'Users'"),
                ("custom_ministries", "emoji",                      "VARCHAR(10)"),
                ("custom_ministries", "mission_statement",          "TEXT"),
                ("custom_ministries", "vision_statement",           "TEXT"),
                ("custom_ministries", "core_values",                "TEXT"),
                ("custom_ministries", "scripture_verse",            "VARCHAR(500)"),
                ("custom_ministries", "scripture_reference",        "VARCHAR(100)"),
                ("custom_ministries", "contact_email",              "VARCHAR(255)"),
                ("custom_ministries", "contact_phone",              "VARCHAR(50)"),
                ("custom_ministries", "whatsapp_number",            "VARCHAR(50)"),
                ("custom_ministries", "whatsapp_group_link",        "VARCHAR(500)"),
                ("custom_ministries", "facebook_url",               "VARCHAR(500)"),
                ("custom_ministries", "instagram_url",              "VARCHAR(500)"),
                ("custom_ministries", "twitter_url",                "VARCHAR(500)"),
                ("custom_ministries", "youtube_url",                "VARCHAR(500)"),
                ("custom_ministries", "website_url",                "VARCHAR(500)"),
                ("custom_ministries", "is_active",                  "BOOLEAN DEFAULT TRUE"),
                ("custom_ministries", "accepts_members",            "BOOLEAN DEFAULT TRUE"),
                ("custom_ministries", "meeting_schedule",           "VARCHAR(300)"),
                ("custom_ministries", "meeting_day",                "VARCHAR(20)"),
                ("custom_ministries", "meeting_time",               "VARCHAR(20)"),
                ("custom_ministries", "location",                   "VARCHAR(300)"),
                ("custom_ministries", "online_meeting_link",        "VARCHAR(500)"),
                ("custom_ministries", "category",                   "VARCHAR(50)"),
                ("custom_ministries", "target_audience",            "VARCHAR(200)"),
                ("custom_ministries", "age_min",                    "INTEGER"),
                ("custom_ministries", "age_max",                    "INTEGER"),
                ("custom_ministries", "gender_filter",              "VARCHAR(20)"),
                ("custom_ministries", "requires_approval",          "BOOLEAN DEFAULT TRUE"),
                ("custom_ministries", "membership_fee",             "DOUBLE PRECISION"),
                ("custom_ministries", "requires_baptism",           "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "requires_application",       "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "application_questions",      "JSON"),
                ("custom_ministries", "gallery_images",             "JSON"),
                ("custom_ministries", "goals",                      "TEXT"),
                ("custom_ministries", "impact_stats",               "JSON"),
                ("custom_ministries", "faqs",                       "JSON"),
                ("custom_ministries", "is_featured",                "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "show_on_homepage",           "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "department_motto",           "VARCHAR(500)"),
                ("custom_ministries", "department_pledge",          "TEXT"),
                ("custom_ministries", "time_commitment_hours",      "INTEGER"),
                ("custom_ministries", "time_commitment_period",     "VARCHAR(20)"),
                ("custom_ministries", "background_check_required",  "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "background_check_type",      "VARCHAR(100)"),
                ("custom_ministries", "dress_code",                 "TEXT"),
                ("custom_ministries", "dress_code_image_url",       "VARCHAR(500)"),
                ("custom_ministries", "skills_required",            "JSON"),
                ("custom_ministries", "training_requirements",      "JSON"),
                ("custom_ministries", "onboarding_steps",           "JSON"),
                ("custom_ministries", "equipment_provided",         "JSON"),
                ("custom_ministries", "sop_document_url",           "VARCHAR(500)"),
                ("custom_ministries", "manual_url",                 "VARCHAR(500)"),
                ("custom_ministries", "emergency_contact_required", "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "photo_id_required",          "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "references_required",        "BOOLEAN DEFAULT FALSE"),
                ("custom_ministries", "recognition_levels",         "JSON"),
                ("custom_ministries", "features",                   "JSON"),
                ("custom_ministries", "sort_order",                 "INTEGER DEFAULT 0"),
                ("custom_ministries", "created_by",                 "VARCHAR(36)"),
                ("custom_ministries", "created_at",                 "TIMESTAMP DEFAULT now()"),
                ("custom_ministries", "updated_at",                 "TIMESTAMP DEFAULT now()"),
