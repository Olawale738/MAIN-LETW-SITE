    ...
    const getDefaultData = (type: BlockType) => {
        switch (type) {
            ...
            case 'founder-card': return {
                ...
                name: 'Our Founder',
                quote: 'My burden is to see lives radically transformed by the unfiltered Word of God.',
                bio: 'A pastor with a deep mandate to awaken destinies and release people into God\'s purpose.',
                image: '/Founder.png',
