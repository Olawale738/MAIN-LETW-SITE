...
const DEPARTMENTS: VDept[] = [
    ...
    { key: 'bible-study', name: 'Bible Study Facilitator', description: 'Lead small-group discussions and help members dig into the Word.',      icon: BookOpen,       color: '#7c3aed', kind: 'service', service: 'Bible study', dashboardUrl: '/bible-study',                requestUrl: '/onboarding/services' },
