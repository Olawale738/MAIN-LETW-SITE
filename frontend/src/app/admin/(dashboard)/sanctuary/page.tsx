            ...
            {editing && (
                <div className="bg-white border border-[#140152] rounded-2xl shadow-md p-5">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <input type="number" value={editing.capacity} onChange={e => setEditing({ ...editing, capacity: parseInt(e.target.value) || 0 })} placeholder="Capacity" className="border border-gray-200 rounded-lg px-3 py-2 text-sm" />
