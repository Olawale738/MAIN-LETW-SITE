    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid lg:grid-cols-2 gap-4 mt-6">
                <LeadsPanel groupKind="custom_ministry" groupId="men" groupLabel="Men's Ministry" canManage />
                <AuditLogPanel groupKind="custom_ministry" groupId="men" title="Men's Ministry — Activity Log" canCustomLog />
            </div>
        </div>
    )
}
