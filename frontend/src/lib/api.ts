...
export interface TheologyApplication {
    ...
    initial_password?: string | null; first_login_at?: string | null
...
export const theologyApi = {
    ...
    accept: (token: string) => fetchApi<{ status: string; login_email: string; portal_url: string; temporary_password_sent: boolean; setup_url?: string | null; initial_password?: string | null; letter?: { generated: boolean; sent: boolean; reason?: string | null } }>(
    ...
    pullClassroom: () => fetchApi<{ ok: boolean; source: string; rows_read: number; newly_enrolled: number; already_enrolled: number; unmatched: number; wrong_course: number; unverified_course: number; details: { enrolled: { admission_number: string; name: string }[]; unmatched: { email: string | null; admission_number: string | null }[] } }>('/theology/admin/pull-classroom', { method: 'POST' }),
    ...
    reissuePassword: (id: string) => fetchApi<{ ok: boolean; email: string; initial_password: string; note: string }>(`/theology/admin/applications/${id}/reissue-password`, { method: 'POST' }),
...
export interface TheologyBridgeStatus {
    ...
    duplicates?: { email: string; name: string; count: number; applications: { id: string; admission_number: string | null; status: string; paid: boolean; created_at: string | null }[] }[]
