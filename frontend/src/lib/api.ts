...
export type BlockType = 'hero' | 'hero-slider' | 'content' | 'features' | 'cta' | 'image' | 'video' | 'upcoming-events' | 'sermon-list' | 'leadership-list' | 'button-group' | 'stats' | 'testimonies' | 'scripture' | 'service-times' | 'gallery' | 'newsletter' | 'scripture-marquee' | 'timeline';
